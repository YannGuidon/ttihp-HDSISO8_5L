...
/* johnson8.v  by whygee@f-cpu.org
  ...
  using raw cells from iHP CMOS5L PDK
...
module Johnson8(
  ...
  // The decoder
  (* keep *) sg13cmos5l_a21o_2 dec0(.X(Decoded8[0]), .A1(J4N[3]), .A2(J4N[0]), .B1(rstN));
  (* keep *) sg13cmos5l_a21o_2 dec1(.X(Decoded8[1]), .A1(J4P[0]), .A2(J4N[1]), .B1(rstN));
  (* keep *) sg13cmos5l_a21o_2 dec2(.X(Decoded8[2]), .A1(J4P[1]), .A2(J4N[2]), .B1(rstN));
  (* keep *) sg13cmos5l_a21o_2 dec3(.X(Decoded8[3]), .A1(J4P[2]), .A2(J4N[3]), .B1(rstN));
  (* keep *) sg13cmos5l_a21o_2 dec4(.X(Decoded8[4]), .A1(J4P[3]), .A2(J4P[0]), .B1(rstN));
  (* keep *) sg13cmos5l_a21o_2 dec5(.X(Decoded8[5]), .A1(J4N[0]), .A2(J4P[1]), .B1(rstN));
  (* keep *) sg13cmos5l_a21o_2 dec6(.X(Decoded8[6]), .A1(J4N[1]), .A2(J4P[2]), .B1(rstN));
  (* keep *) sg13cmos5l_a21o_2 dec7(.X(Decoded8[7]), .A1(J4N[2]), .A2(J4P[3]), .B1(rstN));
